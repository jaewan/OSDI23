...
parser.add_argument('--NUM_WORKER', '-nw', type=int, default=4)
...
def simple():
    ...
    o1 = small_obj_producer.remote()
    o2 = small_obj_producer.remote()
    o3 = small_obj_producer.remote()
    res = consumer.remote(o1,o2,o3)
    ray.get(res)
    del o1
    del o2
    del o3
