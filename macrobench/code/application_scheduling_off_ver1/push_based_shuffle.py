...
class PushBasedShufflePlan(ShuffleOp):
    ...
    def execute(
        ...
        *,
        ...
        logger.info("Using app level off push-based shuffle.")
        ...
        map_stage_executor = _PipelinedStageExecutor(
            map_stage_iter, stage.num_map_tasks_per_round, 
            max_concurrent_rounds = stage.num_rounds, progress_bar=map_bar, function_name="Map"
        )
        ...
        merge_stage_executor = _PipelinedStageExecutor(
            merge_stage_iter, stage.num_merge_tasks_per_round,
        ...
        reduce_stage_executor = _PipelinedStageExecutor(
            ...
            max_concurrent_rounds=stage.num_rounds,
